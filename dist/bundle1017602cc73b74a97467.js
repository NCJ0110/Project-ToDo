...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n}\n\n:root {\n    --main-black: #222;\n    --main-white: #fff;\n    --main-color: rgb(255, 183, 49);\n    --main-transition: all 0.3s linear;\n    --light-border: 1px solid rgba(0,0,0,0.1);\n    --header-height: 60px;\n}\n\nbody {\n    font-family: 'Lato';\n    height: 100vh;\n    width: 100vw;\n    color: var(--main-black);\n    user-select: none;\n\n}\n\nmain {\n    display: flex;\n}\n/*HEADER STYLES */\n.header {\n    width: 100vw;\n    height: var(--header-height);\n    border-bottom: var(--light-border);\n    display: flex;\n}\n\n.header-center {\n    width: 100vw;\n    margin: 0 auto;\n    padding: 0.5rem 2rem;\n}\n\n.logo {\n    font-size: 1.2rem;\n    user-select: none;\n}\n\n\n/* LEFT NAV STYLES */\n\n.leftside-nav {\n    height: calc(100vh - 60px);\n    width: 25%;\n    min-width: 200px;\n    display: flex;\n    flex-direction: column;\n    border-right: var(--light-border);\n    position: relative;\n}\n\n.project-header {\n    display: flex;\n    width: 100%;\n    height: 60px;\n    justify-content: center;\n    align-items: center;\n    gap: 1.5rem;\n    padding: 1rem 0;\n    border-bottom: var(--light-border);\n}\n\n.fa-folder-plus {\n    cursor: pointer;\n    font-size: 1.2rem;\n}\n\n.projects {\n    padding: 0rem 0.5rem;\n}\n\n.project {\n    max-width: 250px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    border: 1px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    padding: 0.75rem 0.5rem;\n    margin: 1rem auto;\n    cursor: pointer;\n}\n\n.project i {\n    font-size: 1.2rem;\n    color: var(--main-black)\n}\n\n.project-add-form {\n    width: 100%;\n    position: absolute;\n    bottom: calc(100vh);\n    padding: 1rem 1rem;\n    z-index: 2;\n}\n\n.project-add-form-title {\n    font-size: 1.2rem;\n    display: inline-block;\n    margin-bottom: 2rem;\n    \n}\n\n.project-add-form i {\n    padding-left: 1.5rem;\n    font-size: 1.2rem;\n    cursor: pointer;\n}\n\n.project-add-form-active {\n    top: 0px;\n    height: 100%;\n    background: white;\n}\n\n.project-add-form label {\n    font-size: 1.2rem;\n    font-weight: bold;\n    margin-bottom: 0.5rem;\n    width: 100%;\n    text-align: center;\n    display: block;\n}\n\n.project-add-form input {\n    padding: 0.25rem 0.5rem;\n    font-size: 1rem;\n    width: 100%;\n}\n\n.submit-add-project {\n    padding: 0.5rem 1rem;\n    background: var(--main-white);\n    border: 2px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    margin-top: 3rem;  \n    cursor: pointer;\n    transition: var(--main-transition);\n}\n\n.submit-add-project:hover {\n    background: var(--main-black);\n    color: var(--main-white);\n}\n\n\n.btn-container {\n    display: flex;\n    justify-content: center;\n}\n\n/* MAIN BODY STYLES */\n\n.main-body {\n    width: 100%;\n    position: relative;\n}\n\n.main-body-header {\n    display: grid;\n    grid-template-columns: 1fr 2fr 1fr;\n    height: 60px;\n    border-bottom: var(--light-border);\n\n}\n\n.current-project {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 0.5rem;\n    font-size: 1.1rem;\n}\n\n.current-project i {\n    cursor: pointer;\n    font-size: 1.2rem;\n}\n\n.current-project-title{\n    width: 150px;\n    cursor: pointer;\n}\n\n.add-todo {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 1.2rem;\n    border-left: var(--light-border);\n\n}\n\n.add-todo i {\n    cursor: pointer;\n}\n\n\n.todo-container {\n    padding: 1rem;\n    width: 100%;\n    text-align: center;\n    color: rgb(194, 194, 194);\n    font-size: 2rem;\n}\n\n.todo {\n    border: 1px solid rgba(0,0,0,0.2);\n    max-width: 500px;\n    margin: 0 auto;\n    display: grid;\n    color: var(--main-black);\n    font-size: 1.1rem;\n    grid-template-columns: 30px 1fr 0.1fr;\n}\n\n.todo + .todo {\n    margin-top: 1rem;\n}\n\n.priority-low {\n    width: 15px;\n    border-right: green;\n    background-color: green;\n}\n\n.priority-medium {\n    width: 15px;\n    border-right: yellow;\n    background-color: yellow;\n}\n\n.priority-high {\n    width: 15px;\n    border-right: red;\n    background-color: red;\n}\n\n.info {\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    align-items: flex-start;\n    gap: 1rem;\n}\n\n.info, .edit-btn {\n    padding: 1rem;\n    justify-content: center;\n}\n\n.edit-btn {\n    font-size: 1.2rem;\n    cursor: pointer;\n}\n\n@media screen and (max-width: 600px){\n    .main-body-header {\n        padding: 0rem 0.5rem;\n        grid-template-columns: 0fr 2fr 1fr;\n    }\n\n    .current-project i {\n        padding-right: 0.5rem;\n    }\n\n    .current-project-title {\n        font-size: 1.2rem;\n    }\n}\n\n/* ADD TODO FORM */\n.add-todo-form {\n    background-color: var(--main-white);\n    width: 100%;\n    position: absolute;\n    bottom: calc(100vh);\n    left: 0px;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    align-items: center;\n    padding: 2rem 2rem;\n    transition: var(--main-transition);\n    z-index: 2;\n    \n}\n\n.add-todo-form-active {\n    top: 0px;\n    height: 100%;\n}\n\n.form-item {\n    display: flex;\n    flex-direction: column;\n    text-align: center;\n    margin-top: 2rem;\n}\n\n.form-item label {\n    font-size: 1.2rem;\n    padding-bottom: 0.75rem;\n}\n\n.form-item input {\n    font-size: 1.2rem;\n    padding: 0.5rem 0.25rem;\n    text-align: center;\n}\n\n.form-item select{\n    padding: 0.5rem;\n}\n\n.submit-add-todo {\n    padding: 1rem 1.5rem;\n    background: var(--main-white);\n    border: 2px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    margin-top: 6rem;  \n    cursor: pointer;\n    transition: var(--main-transition);\n}\n\n.submit-add-todo:hover {\n    background: var(--main-black);\n    color: var(--main-white);\n}", "",{"version":3,"sources":["webpack://./src/styles/styles.css"],"names":[],"mappings":"AAEA;IACI,UAAU;IACV,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,+BAA+B;IAC/B,kCAAkC;IAClC,yCAAyC;IACzC,qBAAqB;AACzB;;AAEA;IACI,mBAAmB;IACnB,aAAa;IACb,YAAY;IACZ,wBAAwB;IACxB,iBAAiB;;AAErB;;AAEA;IACI,aAAa;AACjB;AACA,iBAAiB;AACjB;IACI,YAAY;IACZ,4BAA4B;IAC5B,kCAAkC;IAClC,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,cAAc;IACd,oBAAoB;AACxB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;AACrB;;;AAGA,oBAAoB;;AAEpB;IACI,0BAA0B;IAC1B,UAAU;IACV,gBAAgB;IAChB,aAAa;IACb,sBAAsB;IACtB,iCAAiC;IACjC,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,WAAW;IACX,YAAY;IACZ,uBAAuB;IACvB,mBAAmB;IACnB,WAAW;IACX,eAAe;IACf,kCAAkC;AACtC;;AAEA;IACI,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,oBAAoB;AACxB;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,mBAAmB;IACnB,8BAA8B;IAC9B,iCAAiC;IACjC,kBAAkB;IAClB,uBAAuB;IACvB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB;AACJ;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,mBAAmB;IACnB,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,iBAAiB;IACjB,qBAAqB;IACrB,mBAAmB;;AAEvB;;AAEA;IACI,oBAAoB;IACpB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,QAAQ;IACR,YAAY;IACZ,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;IACjB,iBAAiB;IACjB,qBAAqB;IACrB,WAAW;IACX,kBAAkB;IAClB,cAAc;AAClB;;AAEA;IACI,uBAAuB;IACvB,eAAe;IACf,WAAW;AACf;;AAEA;IACI,oBAAoB;IACpB,6BAA6B;IAC7B,iCAAiC;IACjC,kBAAkB;IAClB,gBAAgB;IAChB,eAAe;IACf,kCAAkC;AACtC;;AAEA;IACI,6BAA6B;IAC7B,wBAAwB;AAC5B;;;AAGA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA,qBAAqB;;AAErB;IACI,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,kCAAkC;IAClC,YAAY;IACZ,kCAAkC;;AAEtC;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,WAAW;IACX,iBAAiB;AACrB;;AAEA;IACI,eAAe;IACf,iBAAiB;AACrB;;AAEA;IACI,YAAY;IACZ,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,iBAAiB;IACjB,gCAAgC;;AAEpC;;AAEA;IACI,eAAe;AACnB;;;AAGA;IACI,aAAa;IACb,WAAW;IACX,kBAAkB;IAClB,yBAAyB;IACzB,eAAe;AACnB;;AAEA;IACI,iCAAiC;IACjC,gBAAgB;IAChB,cAAc;IACd,aAAa;IACb,wBAAwB;IACxB,iBAAiB;IACjB,qCAAqC;AACzC;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,WAAW;IACX,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,WAAW;IACX,oBAAoB;IACpB,wBAAwB;AAC5B;;AAEA;IACI,WAAW;IACX,iBAAiB;IACjB,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,2BAA2B;IAC3B,uBAAuB;IACvB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI;QACI,oBAAoB;QACpB,kCAAkC;IACtC;;IAEA;QACI,qBAAqB;IACzB;;IAEA;QACI,iBAAiB;IACrB;AACJ;;AAEA,kBAAkB;AAClB;IACI,mCAAmC;IACnC,WAAW;IACX,kBAAkB;IAClB,mBAAmB;IACnB,SAAS;IACT,aAAa;IACb,sBAAsB;IACtB,2BAA2B;IAC3B,mBAAmB;IACnB,kBAAkB;IAClB,kCAAkC;IAClC,UAAU;;AAEd;;AAEA;IACI,QAAQ;IACR,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,gBAAgB;AACpB;;AAEA;IACI,iBAAiB;IACjB,uBAAuB;AAC3B;;AAEA;IACI,iBAAiB;IACjB,uBAAuB;IACvB,kBAAkB;AACtB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,oBAAoB;IACpB,6BAA6B;IAC7B,iCAAiC;IACjC,kBAAkB;IAClB,gBAAgB;IAChB,eAAe;IACf,kCAAkC;AACtC;;AAEA;IACI,6BAA6B;IAC7B,wBAAwB;AAC5B","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Lato:wght@400;700&display=swap');\n\n* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n}\n\n:root {\n    --main-black: #222;\n    --main-white: #fff;\n    --main-color: rgb(255, 183, 49);\n    --main-transition: all 0.3s linear;\n    --light-border: 1px solid rgba(0,0,0,0.1);\n    --header-height: 60px;\n}\n\nbody {\n    font-family: 'Lato';\n    height: 100vh;\n    width: 100vw;\n    color: var(--main-black);\n    user-select: none;\n\n}\n\nmain {\n    display: flex;\n}\n/*HEADER STYLES */\n.header {\n    width: 100vw;\n    height: var(--header-height);\n    border-bottom: var(--light-border);\n    display: flex;\n}\n\n.header-center {\n    width: 100vw;\n    margin: 0 auto;\n    padding: 0.5rem 2rem;\n}\n\n.logo {\n    font-size: 1.2rem;\n    user-select: none;\n}\n\n\n/* LEFT NAV STYLES */\n\n.leftside-nav {\n    height: calc(100vh - 60px);\n    width: 25%;\n    min-width: 200px;\n    display: flex;\n    flex-direction: column;\n    border-right: var(--light-border);\n    position: relative;\n}\n\n.project-header {\n    display: flex;\n    width: 100%;\n    height: 60px;\n    justify-content: center;\n    align-items: center;\n    gap: 1.5rem;\n    padding: 1rem 0;\n    border-bottom: var(--light-border);\n}\n\n.fa-folder-plus {\n    cursor: pointer;\n    font-size: 1.2rem;\n}\n\n.projects {\n    padding: 0rem 0.5rem;\n}\n\n.project {\n    max-width: 250px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    border: 1px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    padding: 0.75rem 0.5rem;\n    margin: 1rem auto;\n    cursor: pointer;\n}\n\n.project i {\n    font-size: 1.2rem;\n    color: var(--main-black)\n}\n\n.project-add-form {\n    width: 100%;\n    position: absolute;\n    bottom: calc(100vh);\n    padding: 1rem 1rem;\n    z-index: 2;\n}\n\n.project-add-form-title {\n    font-size: 1.2rem;\n    display: inline-block;\n    margin-bottom: 2rem;\n    \n}\n\n.project-add-form i {\n    padding-left: 1.5rem;\n    font-size: 1.2rem;\n    cursor: pointer;\n}\n\n.project-add-form-active {\n    top: 0px;\n    height: 100%;\n    background: white;\n}\n\n.project-add-form label {\n    font-size: 1.2rem;\n    font-weight: bold;\n    margin-bottom: 0.5rem;\n    width: 100%;\n    text-align: center;\n    display: block;\n}\n\n.project-add-form input {\n    padding: 0.25rem 0.5rem;\n    font-size: 1rem;\n    width: 100%;\n}\n\n.submit-add-project {\n    padding: 0.5rem 1rem;\n    background: var(--main-white);\n    border: 2px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    margin-top: 3rem;  \n    cursor: pointer;\n    transition: var(--main-transition);\n}\n\n.submit-add-project:hover {\n    background: var(--main-black);\n    color: var(--main-white);\n}\n\n\n.btn-container {\n    display: flex;\n    justify-content: center;\n}\n\n/* MAIN BODY STYLES */\n\n.main-body {\n    width: 100%;\n    position: relative;\n}\n\n.main-body-header {\n    display: grid;\n    grid-template-columns: 1fr 2fr 1fr;\n    height: 60px;\n    border-bottom: var(--light-border);\n\n}\n\n.current-project {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 0.5rem;\n    font-size: 1.1rem;\n}\n\n.current-project i {\n    cursor: pointer;\n    font-size: 1.2rem;\n}\n\n.current-project-title{\n    width: 150px;\n    cursor: pointer;\n}\n\n.add-todo {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 1.2rem;\n    border-left: var(--light-border);\n\n}\n\n.add-todo i {\n    cursor: pointer;\n}\n\n\n.todo-container {\n    padding: 1rem;\n    width: 100%;\n    text-align: center;\n    color: rgb(194, 194, 194);\n    font-size: 2rem;\n}\n\n.todo {\n    border: 1px solid rgba(0,0,0,0.2);\n    max-width: 500px;\n    margin: 0 auto;\n    display: grid;\n    color: var(--main-black);\n    font-size: 1.1rem;\n    grid-template-columns: 30px 1fr 0.1fr;\n}\n\n.todo + .todo {\n    margin-top: 1rem;\n}\n\n.priority-low {\n    width: 15px;\n    border-right: green;\n    background-color: green;\n}\n\n.priority-medium {\n    width: 15px;\n    border-right: yellow;\n    background-color: yellow;\n}\n\n.priority-high {\n    width: 15px;\n    border-right: red;\n    background-color: red;\n}\n\n.info {\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    align-items: flex-start;\n    gap: 1rem;\n}\n\n.info, .edit-btn {\n    padding: 1rem;\n    justify-content: center;\n}\n\n.edit-btn {\n    font-size: 1.2rem;\n    cursor: pointer;\n}\n\n@media screen and (max-width: 600px){\n    .main-body-header {\n        padding: 0rem 0.5rem;\n        grid-template-columns: 0fr 2fr 1fr;\n    }\n\n    .current-project i {\n        padding-right: 0.5rem;\n    }\n\n    .current-project-title {\n        font-size: 1.2rem;\n    }\n}\n\n/* ADD TODO FORM */\n.add-todo-form {\n    background-color: var(--main-white);\n    width: 100%;\n    position: absolute;\n    bottom: calc(100vh);\n    left: 0px;\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    align-items: center;\n    padding: 2rem 2rem;\n    transition: var(--main-transition);\n    z-index: 2;\n    \n}\n\n.add-todo-form-active {\n    top: 0px;\n    height: 100%;\n}\n\n.form-item {\n    display: flex;\n    flex-direction: column;\n    text-align: center;\n    margin-top: 2rem;\n}\n\n.form-item label {\n    font-size: 1.2rem;\n    padding-bottom: 0.75rem;\n}\n\n.form-item input {\n    font-size: 1.2rem;\n    padding: 0.5rem 0.25rem;\n    text-align: center;\n}\n\n.form-item select{\n    padding: 0.5rem;\n}\n\n.submit-add-todo {\n    padding: 1rem 1.5rem;\n    background: var(--main-white);\n    border: 2px solid rgba(0,0,0,0.2);\n    border-radius: 3px;\n    margin-top: 6rem;  \n    cursor: pointer;\n    transition: var(--main-transition);\n}\n\n.submit-add-todo:hover {\n    background: var(--main-black);\n    color: var(--main-white);\n}"],"sourceRoot":""}]);
// Exports
...
class Project {
    constructor(title){
        ...
        this.todos = [new _Todo__WEBPACK_IMPORTED_MODULE_0__.Todo("test", "2023", "low")];
    }
}
...
/******/ })()
;
//# sourceMappingURL=bundle1017602cc73b74a97467.js.map